...
import { R as venueLabel, a as chartHostLabel, i as bookVenue } from "./tick.server-DYwNr8MZ.mjs";
import { B as require_react, b as require_jsx_runtime, v as Link, y as useRouter } from "../_libs/@tanstack/react-router+[...].mjs";
import { g as useLocale, l as saveDeskSettings, m as tickNow } from "./functions-D1fgtqih.mjs";
import { c as Route$8 } from "./router-kf2Pjw6r.mjs";
import { a as fmtPct, c as fmtUsd, f as usdToMillions, s as fmtR, t as DeskShell, u as millionsToUsd } from "./shell-nfsQvvNB.mjs";
import { t as Button } from "./button-CcRDLENc.mjs";
import { n as Label, t as Input } from "./field-B2YuifSf.mjs";
import { n as useCronWatchdog, r as useLiveDesk, t as StatusChip } from "./use-live-desk-CqPO2xoy.mjs";
import { i as SignalsTable, n as PositionsTable, t as Kpi } from "./tables-zfW_kLwj.mjs";
import { a as ResponsiveContainer, i as Area, n as YAxis, o as Tooltip, r as XAxis, t as AreaChart } from "../_libs/recharts+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-PTaRT4Q_.js
...
function Home() {
	...
	const [maxLev, setMaxLev] = (0, import_react.useState)(String(s.maxLeverage ?? 200));
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								...
								children: locale === "fa" ? `سقف اهرم ${s.maxLeverage ?? 200}x` : `Leverage cap ${s.maxLeverage ?? 200}x`
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mb-4 grid gap-1.5 rounded-lg border border-accent/50 bg-surface-2 p-3",
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: [
										...
										className: `min-h-8 rounded-sm border px-2 text-xs ${Number(maxLev) === n ? "border-accent bg-surface text-fg" : "border-border text-muted hover:border-border-strong"} disabled:opacity-40`,
										children: [n, "x"]
									}, n))
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									children: (() => {
										...
										return locale === "fa" ? `۱ تا ۲۰۰. ربات از سقف خود ارز بالاتر نمی‌رود. الان: ${capN}٪ مارجین × ${lev}x روی ${coin} ≈ ${fmtUsd(notional, 0)} حجم · سقف ارز ${venueLev}x` : `1–200. Never above that coin's venue max. Now: ${capN}% margin × ${lev}x on ${coin} ≈ ${fmtUsd(notional, 0)} notional · venue max ${venueLev}x`;
									})()
								})
							]
						}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [
								...
								locale === "fa" ? ` سقف اهرم ${s.maxLeverage ?? 200}x — بالاتر از سقف خود ارز نمی‌رود.` : ` Leverage cap ${s.maxLeverage ?? 200}x — never above that coin's venue max.`,
								saveMsg ? ` · ${saveMsg}` : "",
