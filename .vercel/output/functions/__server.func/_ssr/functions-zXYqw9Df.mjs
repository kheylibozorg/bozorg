...
//#region node_modules/.nitro/vite/services/ssr/assets/functions-zXYqw9Df.js
...
var copy = {
	fa: {
		...
		risk: "ریسک هر معامله",
		capital: "درصد سرمایه",
		capitalHint: "از موجودی، به‌عنوان مارجین هر معامله. لوریج همیشه بالاترین سقف همان ارز است؛ اگر بالای ۲۰۰ بود همان ۲۰۰.",
		scanBatch: "ارز در هر تیک",
		autoLev: "لوریج خودکار سقف",
		...
		how: "نحوه استفاده",
		token: "توکن کرون",
		keys: "کلیدها فقط بعد از باز کردن پین ذخیره می‌شوند. Test سبز = زنده مسلح. کرون خودش سفارش می‌فرستد.",
	...
	en: {
		...
		risk: "Risk per trade",
		capital: "Capital %",
		capitalHint: "Share of equity used as margin per trade. Leverage is that coin's venue max, hard-capped at 200x.",
		scanBatch: "Coins per tick",
		autoLev: "Auto max leverage",
		...
		how: "How to use",
		token: "Cron token",
		keys: "API keys save only after the operator PIN is unlocked. A green Test arms live; cron sends the order.",
