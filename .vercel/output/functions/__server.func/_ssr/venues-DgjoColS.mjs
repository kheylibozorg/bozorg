...
import { n as VENUE_META } from "./tick.server-DYwNr8MZ.mjs";
import { B as require_react, b as require_jsx_runtime, y as useRouter } from "../_libs/@tanstack/react-router+[...].mjs";
import { g as useLocale, l as saveDeskSettings, p as testVenue } from "./functions-D1fgtqih.mjs";
import { n as Route$1 } from "./router-kf2Pjw6r.mjs";
import { f as usdToMillions, t as DeskShell, u as millionsToUsd } from "./shell-nfsQvvNB.mjs";
import { t as Button } from "./button-CcRDLENc.mjs";
import { n as Label, r as Select, t as Input } from "./field-B2YuifSf.mjs";
import { t as LockPanel } from "./lock-panel-AJfW9kV0.mjs";
import { t as Badge } from "./badge-CcZoPOMs.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/venues-DgjoColS.js
...
function Page() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DeskShell, { children: [
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: [
								...
								className: `min-h-8 rounded-sm border px-2 text-xs ${Number(maxLev) === n ? "border-accent bg-surface-2 text-fg" : "border-border text-muted hover:border-border-strong"} disabled:opacity-40`,
								children: [n, "x"]
							}, n))
						})
					]
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			children: fa ? "حداکثر اهرم را خودت می‌گذاری (۱ تا ۲۰۰). ربات از سقف خود ارز روی صرافی بالاتر نمی‌رود. درصد سرمایه مارجین است. کلید را Save یا Test کن تا زنده مسلح شود." : "You set max leverage (1–200). The bot never exceeds that coin's venue max. Capital % is margin. Save or Test keys to arm live."
		})
	] });
}
//#endregion
