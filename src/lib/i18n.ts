...
export const copy = {
  fa: {
    ...
    risk: "ریسک هر معامله",
    capital: "درصد سرمایه",
    capitalHint: "از موجودی، به‌عنوان مارجین هر معامله. اهرم = کمینهٔ سقف همان ارز روی صرافی و حداکثر اهرمی که پایین می‌گذاری.",
  ...
  en: {
    ...
    risk: "Risk per trade",
    capital: "Capital %",
    capitalHint: "Share of equity used as margin per trade. Leverage is the lower of that coin's venue max and your cap below.",
    scanBatch: "Coins per tick",
    autoLev: "Max leverage",
